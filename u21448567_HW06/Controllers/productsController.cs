...
namespace u21448567_HW06.Controllers
{
    public class productsController : Controller
    {
        ...
        //    return View(db.products.Where(x => x.product_name.Contains(searchString) || searchString == null).ToList().ToPagedList(page ?? 1, 10));
        //}
        ...
        public ActionResult Index(int ? i, string searchString)
        {
            ...
            List<product> products = db.products.ToList();
            return View(db.products.Where(x => x.product_name.Contains(searchString) || searchString == null).ToList().ToPagedList(i ?? 1, 10));
        }
